        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-6">
                ...
                <div class="border border-indigo-200 rounded-lg p-4 bg-indigo-50">
                    ...
                    <p class="text-xs text-gray-600 mb-3">Define quais usuários podem ver e usar este tipo de documento ao criar documentos digitais.</p>
                    <div class="space-y-2">
                        <label class="flex items-center gap-3 p-2.5 bg-white rounded-lg border border-gray-200 cursor-pointer hover:border-indigo-300 transition">
                            <input type="radio" name="visibilidade" value="todos" {{ old('visibilidade', 'todos') === 'todos' ? 'checked' : '' }} class="w-4 h-4 text-indigo-600 focus:ring-indigo-500">
                            <div>
                        ...
                        <label class="flex items-center gap-3 p-2.5 bg-white rounded-lg border border-gray-200 cursor-pointer hover:border-indigo-300 transition">
                            <input type="radio" name="visibilidade" value="estadual" {{ old('visibilidade') === 'estadual' ? 'checked' : '' }} class="w-4 h-4 text-indigo-600 focus:ring-indigo-500">
                            <div>
                        ...
                        <label class="flex items-center gap-3 p-2.5 bg-white rounded-lg border border-gray-200 cursor-pointer hover:border-indigo-300 transition">
                            <input type="radio" name="visibilidade" value="municipal" {{ old('visibilidade') === 'municipal' ? 'checked' : '' }} class="w-4 h-4 text-indigo-600 focus:ring-indigo-500">
                            <div>
                ...
                <div class="border border-amber-200 rounded-lg p-4 bg-amber-50">
                    ...
                    <label class="flex items-start cursor-pointer">
                        <input type="checkbox"
                               ...
                               value="1"
                               {{ old('exige_itens_atendimento') ? 'checked' : '' }}
