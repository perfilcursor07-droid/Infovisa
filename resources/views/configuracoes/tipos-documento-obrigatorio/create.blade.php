            ...
            <div class="space-y-5">
                ...
                <div class="border-t border-gray-200 pt-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 bg-green-50 border border-green-200 rounded-lg" x-data="{ carimboModo: '{{ old('carimbo_modo', 'desativado') }}' }">
                            ...
                            @php $carimboModoAtual = old('carimbo_modo', 'desativado'); @endphp
                            <div class="space-y-2">
                            ...
                            <div x-show="carimboModo === 'manual'" x-cloak class="mt-4 pt-4 border-t border-green-200">
                                ...
                                <textarea name="carimbo_texto" id="carimbo_texto" rows="3"
                                          ...
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm font-mono">{{ old('carimbo_texto') }}</textarea>
