                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <textarea id="ceps_filtro"
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono text-sm @error('ceps_filtro') border-red-500 @enderror">{{ old('ceps_filtro') }}</textarea>
                        @error('ceps_filtro')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <textarea id="bairros_filtro"
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm @error('bairros_filtro') border-red-500 @enderror">{{ old('bairros_filtro') }}</textarea>
